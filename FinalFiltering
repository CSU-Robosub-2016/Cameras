...
#Convert to HSV to find only orange
hsv_img = cv2.cvtColor(im, cv2.COLOR_BGR2HSV)
#Set min / max values to find only orange
...
ret,thresh = cv2.threshold(frame_threshed,153,255,0)
#Find Contours
...
#Create Rectangle around largest contour
